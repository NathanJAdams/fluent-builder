...
export type SubTypeRegistryBuilder<TSubTypeRegistry extends readonly SubTypeMetadata<any, any, any>[]> = {
  add: <TBase extends Record<string, any>, TSubTypes extends TBase[], TDiscriminator extends string & keyof TBase>
    ...
    : SubTypeRegistryBuilder<[...TSubTypeRegistry, SubTypeMetadata<TBase, TSubTypes, TDiscriminator>]>;
...
export const subTypeRegistryBuilderInternal = <TSubTypeRegistry extends readonly SubTypeMetadata<any, any, any>[]>(entries: TSubTypeRegistry): SubTypeRegistryBuilder<TSubTypeRegistry> => {
  return {
    add: <TBase extends Record<string, any>, TSubTypes extends TBase[], TDiscriminator extends string & keyof TBase>() => {
      return subTypeRegistryBuilderInternal([...entries, null as any as SubTypeMetadata<TBase, TSubTypes, TDiscriminator>] as const) as any;
    },
    build: () => entries,
  };
};
